document.addEventListener('turbolinks:load', function() {
    ...
    //   $('.notifications-container-own').toggleClass('show-own');
    //   $('.notifications-container-own').removeClass('chat-extend-own');
    // });
    ...
    $(".offcanvas-btn-close,.offcanvas-overlay,.nav-icon-container-own").on('click', function () {
